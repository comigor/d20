...
void main() {
  group('on D20.roll', () {
    ...
    test('different seeds yield different rolls', () {
      final die1 = D20(random: Random(0));
      final die2 = D20(random: Random(1));
      expect(die1.roll('d20'), isNot(die2.roll('d20')));
    });

    test('d% is an alias for d100', () {
      final die1 = D20(random: Random(0));
      final die2 = D20(random: Random(0));
  ...
  group('on D20.rollWithStatistics', () {
    ...
    test('rolls are computed from last to first (for optimization)', () {
      final die = D20();
      final statistics = die.rollWithStatistics('d8 + d100');
    ...
    test('it has the correct amount of rolls and rolls within', () {
      final die = D20();
      final statistics = die.rollWithStatistics('2d20-L + 6d6');
    ...
    test('it correctly parses a single result', () {
      final die = D20(random: Random(0));
      final statistics = die.rollWithStatistics('1d1 + 7d6-L + 1d1');
